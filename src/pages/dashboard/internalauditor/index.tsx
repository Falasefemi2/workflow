...
export default function InternalAuditorDashboard() {
  ...
  const resolveActiveTab = () => {
    ...
    if (
      pathname === "/dashboard/internalauditor" ||
      pathname === "/dashboard/internalauditor/menu" ||
      pathname === "/dashboard/internalauditor/dashboard"
    ) {
      return "menu";
    }
    if (pathname.startsWith("/dashboard/internalauditor/profile")) {
      return "profile";
    }
    return "menu";
  };
  ...
  const handleTabChange = (tab: string) => {
    if (tab === "menu") {
      navigate("/dashboard/internalauditor");
      return;
    }
    navigate(`/dashboard/internalauditor/${tab}`);
  };
