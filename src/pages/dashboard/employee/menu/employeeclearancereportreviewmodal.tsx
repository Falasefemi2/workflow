...
interface EmployeeClearanceReportReviewModalProps {
  isOpen: boolean;
  onClose: () => void;
  report: EmployeeClearanceReport | null;
}

export function EmployeeClearanceReportReviewModal({
  isOpen,
  onClose,
  report,
}: EmployeeClearanceReportReviewModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh]">
        <DialogHeader>
          <DialogTitle>Clearance Report</DialogTitle>
        </DialogHeader>
