...
import { ClearanceReportReviewModal } from "./clearance-report-review-modal";
...
export default function ClearanceReportPage() {
  ...
  return (
    <div className="pb-12">
      ...
      {/* Table */}
      <div className="rounded-lg border border-border/30 overflow-hidden mt-8">
        <Table>
          <TableHeader>
