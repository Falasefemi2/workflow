...
export default function HODDashboard() {
  ...
  const resolveActiveTab = () => {
    ...
    if (
      pathname === "/dashboard/hod" ||
      pathname === "/dashboard/hod/menu" ||
      pathname === "/dashboard/hod/dashboard"
    ) {
      return "menu";
    }
    if (pathname.startsWith("/dashboard/hod/profile")) {
      return "profile";
    }
    return "menu";
  };
